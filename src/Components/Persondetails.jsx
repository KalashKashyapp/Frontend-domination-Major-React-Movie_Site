...
const Persondetails = () => {
  ...
  useEffect(() => {
    ...
    //mtlb mai page se bahar jaun toh person hat jaye.  
  ...
  return info ? (
    <div className='px-[10%] w-screen h-[150vh] bg-[#1F1E24]'>
      ...
      <div className='w-full flex'>
        ...
        <div className='w-[20%]'>
          <img
            className='shadow-[8px_17px_38px_2px_rgba(0,0,0,.5)] h-[40vh] object-cover transition-transform duration-300 ease-in-out hover:scale-105 '
            src={`https://image.tmdb.org/t/p/original/${info.detail.profile_path}`}
            alt=""
          />

          <hr className='mt-10 mb-5 border-none h-[2px] bg-zinc-500 mr-6' />

          {/* Social Links of Celeb's */}
          ...
          {/* Personal Info. */}
          <h1 className='subtitles font-semibold my-5'>
            At a Glance :
          </h1>
        ...
        <div className='w-[80%] ml-[5%]'>
          ...
          <h1 className='text-6xl text-zinc-100 font-black my-5'>
            {info.detail.name}
          </h1>
          ...
          <div className='w-full h-[50vh] mt-5 overflow-x-hidden overflow-y-auto shadow-lg shadow-[rgba(255,255,255,.2)] 
              border-2 border-zinc-700 list-disc text-zinc-400 p-5'>

            {/* Yha mujhe chahiye ki jo cheez selected ho us hisab se mujhe data mile. */}
