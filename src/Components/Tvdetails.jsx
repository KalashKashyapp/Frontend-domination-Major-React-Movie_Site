...
const Tvdetails = () => {
  ...
  useEffect(() => {
    ...
    //mtlb mai page se bahar jaun toh tv show hat jaye.  
  ...
  return info ? (
    ...
    >
      ...
      <h1 className='subtitles text-3xl font-bold text-white ml-4'>Seasons</h1>

      <div className='w-[100%] flex overflow-y-hidden mb-5 p-5'>
        {info.detail.seasons.length > 0 ? info.detail.seasons.map((s, i) => (

          <div key={i} className='w-[14vh] mr-[6%]'>

            <img className='shadow-[8px_17px_38px_2px_rgba(0,0,0,.5)] min-w-[10vw] h-[30vh] object-cover'
           ...
           One Series, Endless Entertainment !
        </h1>
        }
      </div>
